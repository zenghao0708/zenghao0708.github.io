...
description: 这篇是命令行工具系列里的工具总览版。围绕 AI 编码场景，介绍 fzf、Ghostty、Yazi、Tmux 等工具分别解决什么问题，以及它们如何组成一条更顺的终端工作流。
---
...
![AI 编码命令行分层图](/images/mac-ai-coding-tools/mac-cli-stack.png)
...
![AI 编码任务在终端里的流动](/images/mac-ai-coding-tools/mac-cli-workflow.png)

![工具职责矩阵](/images/mac-ai-coding-tools/mac-cli-matrix.png)
...
- `fzf` 和 `Yazi` 解决的是定位问题
- `Tmux` 解决的是 session 和日志观察问题
- `mise` 解决的是 runtime 所有权问题
- `Ghostty` 解决的是终端本身的交互成本问题
