...
这篇是 OpenClaw 系列里的`架构主稿`。

如果你更关心升级后“为什么飞书消息突然收不到、gateway 为什么挂掉”，那先看排障 skill：

- OpenClaw 升级后飞书恢复：[/Users/zenghao/.codex/skills/openclaw-feishu-upgrade-recovery/SKILL.md](/Users/zenghao/.codex/skills/openclaw-feishu-upgrade-recovery/SKILL.md)
...
![OpenClaw 控制平面结构图](/images/openclaw-architecture/openclaw-control-plane.png)
...
![~/.openclaw 目录角色图](/images/openclaw-architecture/openclaw-home-layout.png)
...
- OpenClaw 升级后飞书恢复 skill：[/Users/zenghao/.codex/skills/openclaw-feishu-upgrade-recovery/SKILL.md](/Users/zenghao/.codex/skills/openclaw-feishu-upgrade-recovery/SKILL.md)
